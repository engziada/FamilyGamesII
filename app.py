...
CONVEX_URL = (os.getenv('CONVEX_URL') or os.getenv('convex_url') or os.getenv('VITE_CONVEX_URL') or os.getenv('vite_convex_url') or '')

if not CONVEX_URL:
    logger.warning("CONVEX_URL is not set! Real-time features will not work.")
