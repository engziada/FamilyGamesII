...
def handle_create_game(data):
    try:
        ...
        if game_type == 'trivia':
            game_obj = TriviaGame(game_id, player_name, settings, avatar)
        elif game_type == 'pictionary':
            game_obj = PictionaryGame(game_id, player_name, settings, avatar)
        else:
            game_obj = CharadesGame(game_id, player_name, settings, avatar)
...
def handle_join_game(data):
    try:
        ...
        game_obj = game_rooms[game_id]
        game_obj.add_player(player_name, avatar)
        session['game_id'] = game_id
        session['player_name'] = player_name
